  ...
  return (
    <div>
      ...
      <div className='flex items-center justify-between '>
        <img className='h-14 mb-3' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReUzM52yYFb13v2VMde12x6WOl8tngXcMJ139O2AHgpt6cv4RFv_8CtyMCYZerfaTizSw&usqp=CAU" alt="" />
